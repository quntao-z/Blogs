...
const mostLikes = (blogs) => {
  const likeCountByAuthor = lodash.mapValues(lodash.groupBy(blogs, 'author'), (blog) => lodash.sumBy(blog, 'likes'));
  const authorWithMostLikes = lodash.maxBy(Object.keys(
    likeCountByAuthor,
  ), (author) => likeCountByAuthor[author]);
  return {
